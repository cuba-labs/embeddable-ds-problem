...
@Table(name = "EDP_SECOND_MAIN")
@Entity(name = "edp$SecondMain")
public class SecondMain extends StandardEntity {
    private static final long serialVersionUID = -6646509251675840908L;
